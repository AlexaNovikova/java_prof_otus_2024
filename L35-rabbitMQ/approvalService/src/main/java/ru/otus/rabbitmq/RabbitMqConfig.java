...
public class RabbitMqConfig {
    ...
    @Bean
    public Queue newClientsEventsQueue2() {
        return QueueBuilder.durable("new-clients-queue2")
                .withArgument("x-dead-letter-exchange", "dead-letter-exchange")
                .build();
    }

    @Bean
    public Binding newClientsEventsQueueBinding2() {
        return BindingBuilder.bind(newClientsEventsQueue2()).to(topicExchange()).with("clients.new_created");
    }
